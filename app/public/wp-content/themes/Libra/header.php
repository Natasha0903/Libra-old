...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Mulish:wght@300;400;500;600;700;800" rel="stylesheet">
...
<body <?php body_class(); ?>>
    ...
    <canvas id="connected_dots_top" class="connected_dots" width="776" height="474"></canvas>
    <header>
        <div class="fixing">
            <div class="container">
                <div class="logo">
...
<!--                        <img src="--><?php //echo get_template_directory_uri(); ?><!--/images/logo.svg" title="" alt=""/>-->
                ...
                <div class="button_wrap">
                    <?php $section_cta = get_field('header_btn', 'option'); ?>
